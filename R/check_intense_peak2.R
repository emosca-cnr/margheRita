...
#' @param n_peaks
#' @param accept_PPM_err
#' @param mode
#'
check_intense_peak2 = function(RT_mass=NULL, RI_lib=NULL , RI_sample=NULL, reference=NULL, lib_peaks_data=NULL, n_peaks=1, accept_PPM_err = 10, mode=c("POS", "NEG")) {
