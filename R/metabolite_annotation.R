...
#' @export
#'
metabolite_annotation = function(mRList = NULL , reference = NULL , feature_spectra = NULL, reference_spectra= NULL, rt_err_thr=1, unaccept_flag=15, accept_flag=5, suffer_flag=10, acceptable_RI = 10, n_peaks=1, acceptable_PPM_err = 10){
  ...
  reference_spectra <- get_spectra_list_from_vector(spectra = setNames(reference$MS_MS_spectrum, reference$Name))
