...
metabolite_annotation.orig <- function(mRList = NULL, library_list = NULL, feature_spectra = NULL, rt_err_thr=1, unaccept_flag=15, accept_flag=5, suffer_flag=10, acceptable_RI = 10, acceptable_PPM_err = 10, mode=NULL, max_RI_diff=30, RI_diff_type="rel"){
