...
visualize_1spectra <- function(feature_id=NULL, peak_id=NULL, RI_sample=NULL, RI_lib = NULL, lib_peaks_data=NULL, out_dir="./", type=c("mirrored", "overlapped"), match_matrix=NULL){
  ...
  plot(library_spectra[, 1] , library_spectra[, 2], xlim=c(min(library_spectra[, 1], feature_spectra[, 1]), max(library_spectra[, 1], feature_spectra[, 1])), ylim = ylim, type = "h" , col= adjustcolor("red", 0.6) , xlab = "m/z", ylab = "Relative Intensity", lwd=2)
