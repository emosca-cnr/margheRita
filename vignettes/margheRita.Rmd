...
batch_effect function remove batch effect using *limma* package. Batch of each samples has to be indicated in a column, as number, in metadata and then reported in sample_ann data frame.
...
## Principal Component Analysis (funzione da rinominare)
